...
<body>
    @if(session()->has('sukses-editproduct'))
    <script>
    ...
    <div class="flex flex-row w-full" style="min-height:100vh">
        ...
        <div class="bg-gray-200 w-full px-4 py-12">
            <h3>Tambah Product</h3><br>
            <form action="" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="nama_product">Nama Product</label>
                    <input type="text" class="form-control" id="nama_product" value="{{$product->name_product}}" name="name_product">
                </div><br>

                <div class="form-group">
                  <label for="gambar_product">Gambar Product</label>
                  <input type="file" class="form-control"  name="gambar_product">
                  <small><b>Kosongkan Jika Tidak Inging Mengedit Gambar</b></small>
                ...
                <br>
                <button type="submit" class="bg-blue-400 px-3 py-1 text-white">Submit</button>
                <a href="/dashboard/manajemen-product"><button type="button" class="bg-blue-400 px-3 py-1 text-white">Kembali</button></a>
              </form>
      <br>     <br>
